...
export const legalThreads: MessageThread[] = [
  ...
  { id: 3, name: 'JusticeLink Support', handle: '@support', preview: 'Your pro-bono hours for Q1 have been verified.', unread: false, time: 'Mar 15' },
];
...
export const publicThreads: MessageThread[] = [
  ...
  { id: 2, name: 'JusticeLink Support', handle: '@support', preview: 'Welcome! Kumusta po ang experience niyo sa platform?', unread: false, time: 'Yesterday' },
];
